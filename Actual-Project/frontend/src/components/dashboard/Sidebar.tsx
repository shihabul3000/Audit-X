...
export const Sidebar: React.FC = () => {
  ...
  // For STUDENT role, the backend getAll already filters to assigned companies only,
  // so all fetched companies are accessible. For admins/super admins, show all.
  const visibleCompanies = currentUser.role === 'STUDENT'
    ? allCompanies
    : allCompanies.filter(c => permissionSelectors.canAccessCompany(currentUser, c));
