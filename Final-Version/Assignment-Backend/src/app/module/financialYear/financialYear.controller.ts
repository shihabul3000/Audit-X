...
const getFinancialYears = catchAsync(async (req: Request, res: Response) => {
  const result = await FinancialYearService.getFinancialYears(req.params.companyId, req.user!.userId, req.user!.role);
...
const createFinancialYear = catchAsync(async (req: Request, res: Response) => {
  const result = await FinancialYearService.createFinancialYear(req.params.companyId, req.body.reportingDate, req.user!.userId);
...
const deleteFinancialYear = catchAsync(async (req: Request, res: Response) => {
  const result = await FinancialYearService.deleteFinancialYear(req.params.yearId, req.user!.userId, req.user!.role);
...
const assignFinancialYear = catchAsync(async (req: Request, res: Response) => {
  const result = await FinancialYearService.assignFinancialYear(req.params.yearId, req.body.userId);
...
const submitYear = catchAsync(async (req: Request, res: Response) => {
  const result = await FinancialYearService.submitFinancialYear(req.params.yearId, req.user!.userId, req.body.note);
