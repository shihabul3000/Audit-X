...
const getYearData = catchAsync(async (req: Request, res: Response) => {
  const result = await AuditDataService.getYearData(req.params.yearId);
...
const saveAuditData = catchAsync(async (req: Request, res: Response) => {
  const result = await AuditDataService.saveAuditData(req.params.yearId, req.body, req.user!.userId);
...
const saveNotesData = catchAsync(async (req: Request, res: Response) => {
  const result = await AuditDataService.saveNotesData(req.params.yearId, req.body, req.user!.userId);
